...
\begin{document}
	...
	\paragraph{} Pro ovládání motorů bylo nutné vybrat \uv{řídící jednotku}. Pro tento účel a kvůli rozměrům se jeví jako jasná volba Arduino Nano, ale kvůli ceně bylo lepší sáhnout po dostupnějším klonu.
	\begin{figure}[H]
		\centering
