...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{images/tisk_kostra_kryt.jpg}
	...
	\paragraph{} Pro ovládání motorů bylo nutné vybrat \uv{řídící jednotku}. Pro tento účel a kvůli rozměrům se jeví jako jasná volba Arduino Nano, ale kvůli ceně je lepší
	\subsection{Terminál}
